...
Issue #166. Base: `main`. Members of a cabal can read and post plain-text messages from the cabal screen (Actions → Cabal chat).
...
- The "Cabal chat" row on the cabal screen (first row under Actions) compiles but wasn't tapped on the simulator.
