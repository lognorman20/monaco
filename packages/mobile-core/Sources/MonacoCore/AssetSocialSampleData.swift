...
public enum AssetSocialSampleData {
    ...
    public static let activity: [AssetActivityDTO] = [
        ...
        AssetActivityDTO(
            ...
            actorName: "Ada", txSignature: "5vJ8sampleSignature1111111111111111111111111",
    ...
    public static func social(symbol: String = "AAPLx") -> AssetSocialDTO {
        AssetSocialDTO(
            symbol: symbol,
    ...
    public static func modest(symbol: String = "AAPLx") -> AssetSocialDTO {
        AssetSocialDTO(
            symbol: symbol,
    ...
    public static func empty(symbol: String = "AAPLx") -> AssetSocialDTO {
    ...
    public static func partial(symbol: String = "AAPLx") -> AssetSocialDTO {
        AssetSocialDTO(
            symbol: symbol,
            holdings: [weekendInvestors],
            openProposals: [],
