...
func (s *Store) GetGroupRules(ctx context.Context, groupID string) (domain.GroupRules, bool, error) {
	...
	return domain.GroupRules{JoinPolicy: domain.JoinPolicy{Mode: parsedJoinMode}, VoterSet: domain.VoterSet{Mode: parsedVoterSetMode}, Threshold: parsedThreshold, VoteExpirySeconds: domain.VoteExpirySeconds(voteExpirySeconds)}, true, nil
}
